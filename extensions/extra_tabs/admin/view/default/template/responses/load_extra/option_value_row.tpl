<tr id="<?php echo $row_id; ?>" class="optionRow">
	...
	?>
    <td class="ml_ckeditor"><?php echo $form['fields']['option_value'];  ?></td>
...
<?php if ($selectable){?>
    <!--<td><a class="remove btn btn-xs btn-danger-alt"><div style="width:16px"><i class="fa fa-minus-circle"></i></div></a></td>-->
<?php } ?>
</tr>
<tr>
